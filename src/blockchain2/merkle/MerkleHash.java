...
public class MerkleHash {
    ...
    public static  MerkleHash createFromHash(String hash) {
        MerkleHash temp = new MerkleHash();
        temp.setValue(hash.getBytes());
        return temp;
    }
    ...
    private void setValue(byte[] value) { this.value = value; }
